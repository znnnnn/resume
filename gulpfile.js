...
gulp.task('default', ['icon-sass', 'resume-sass', 'json2jade', 'copy', 'minify:js'])

gulp.task('default-pdf', ['icon-sass', 'resume-sass', 'json2jade', 'copy'])

gulp.task('pdf', ['set-pdf-port', 'default-pdf', 'webserver'], async () => {
